...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const products = [ 
   ...
   { id: 'p66', title: 'Grand Theft Auto V Enhanced Edition Steam Account – Fresh New Account - Gift From Egycomputers', category: 'games', price: 425, img: 'gtae.jpg', desc: 'هديه من شركة ايجي كمبيوترز مع اي تجميعه / ملحوظه عشان تشتري اي حاجه من الموقع لازم تخش من الرابط الي موجود في كل حاجه او قطعه اتمام والطلب هنا لسه جاري تنفيذه', buyLink:'https://egycomputers.com/product/grand-theft-auto-v-enhanced-edition-global-rockstar/ref/4/' },
